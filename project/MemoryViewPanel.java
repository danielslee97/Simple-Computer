...
public class MemoryViewPanel implements Observer{
	...
	public void update(Observable arg0, Object arg1) {
	    for(int i = lower; i < upper; i++) {
	        ...
	        dataHex[i-lower].setText(Integer.toHexString(model.getData(i)).toUpperCase());
	    }
	...
	public JComponent createMemoryDisplay() {
		...
		dataHex = new JTextField[this.upper - this.lower];
		dataDecimal = new JTextField[this.upper - this.lower];
